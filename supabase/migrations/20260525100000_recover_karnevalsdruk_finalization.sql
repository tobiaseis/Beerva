...
revoke execute on function public.finalize_due_challenges(integer)
...
comment on function public.finalize_due_challenges(integer)
  is 'Finalizes the real KarnevalsDruk challenge, awarding King of Karneval trophies for total pints and highest average ABV.';
