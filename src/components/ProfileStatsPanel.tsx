...
export const ProfileStatsPanel = ({ stats, pintTimeline = [], topPubVisits = [], challengeAwards = [] }: ProfileStatsPanelProps) => {
  ...
  return (
    <>
      <Surface padded={false} style={styles.statsContainer}>
        <View style={styles.statsGridRow}>
          <Pressable
            style={[styles.statBox, styles.statCellRightBorder, styles.statCellBottomBorder]}
          ...
          <Pressable
            style={[styles.statBox, styles.statCellBottomBorder]}
          ...
          <View style={styles.modalSheet}>
            <View style={styles.modalHeader}>
              <View style={styles.modalHeaderCopy}>
                <Text style={styles.modalTitle}>Alcohol Units</Text>
                <Text style={styles.modalSubtitle}>{stats.totalUnits} units consumed all time</Text>
              </View>
              <Pressable
                style={styles.modalCloseButton}
                onPress={() => setUnitsModalVisible(false)}
                accessibilityRole="button"
                accessibilityLabel="Close alcohol unit details"
              >
            ...
            <Text style={styles.explainerText}>
              Beerva totals units from each drink's serving size, quantity, and ABV using the Danish alcohol unit standard.
            </Text>
          </View>
        </View>
      </Modal>
...
const styles = StyleSheet.create({
  ...
  statBox: {
    ...
    minHeight: Platform.OS === 'web' ? 58 : 62,
