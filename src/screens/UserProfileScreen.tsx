    ...
    >
      ...
      <View style={styles.header}>
        ...
        <View style={styles.followStats}>
          <View style={styles.followStat} accessible accessibilityLabel={`${followCounts.followers} followers`}>
          ...
          <View style={styles.followStat} accessible accessibilityLabel={`${followCounts.following} following`}>
            <Text style={styles.followStatText} numberOfLines={1} adjustsFontSizeToFit minimumFontScale={0.82}>
